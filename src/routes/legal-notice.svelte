<main class="container prose mx-auto px-7 py-16">
	...
	<p>
		Daniel Salvado (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the
		danielsalvado.com website (the &quot;Service&quot;).
	</p>

	<p>
		This page informs you of our policies regarding the collection, use, and disclosure of personal
		data when you use our Service and the choices you have associated with that data. Our Privacy
		Policy for Daniel Salvado is created with the help of the{` `}
	...
	<p>
		...
		and Conditions, accessible from danielsalvado.com
	</p>
	...
	<p>Daniel Salvado uses the collected data for various purposes:</p>
	<ul>
	...
	<p>
		If you are located outside Portugal and choose to provide information to us, please note that we
		transfer the data, including Personal Data, to Portugal and process it there.
	</p>
	<p>
	...
	<p>
		Daniel Salvado will take all steps reasonably necessary to ensure that your data is treated
	...
	<p>
		Daniel Salvado may disclose your Personal Data in the good faith belief that such action is
		necessary to:
	</p>
	<ul>
		<li>To comply with a legal obligation</li>
		<li>To protect and defend the rights or property of Daniel Salvado</li>
