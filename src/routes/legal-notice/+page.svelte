<main class="prose dark:prose-invert container mx-auto px-7 py-16">
	...
	<p>
		...
		Privacy Policy have the same meanings as in our Terms and Conditions, accessible from danielsalvado.com
	</p>
	...
	<p>
		If you are located outside Portugal and choose to provide information to us, please note that we transfer the data,
		including Personal Data, to Portugal and process it there.
	</p>
	<p>
	...
	<p>
		Daniel Salvado will take all steps reasonably necessary to ensure that your data is treated securely and in
	...
	<p>Daniel Salvado may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
	<ul>
